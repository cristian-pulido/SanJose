    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ci1', models.NullBooleanField(verbose_name='Paciente con episodio de parada cadíaca con reanimación exitosa')),
                ('ci2', models.NullBooleanField(verbose_name='Paciente con Dx de lesión cerebral aguda de origen traumático o evento cerebrovascular')),
                ...
                ('ce3', models.NullBooleanField(verbose_name='Decisión de la familia de no participar en estudios de investigación')),
