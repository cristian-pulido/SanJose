...
class Radiologia(models.Model):
    ...
    ur_tension_sv = models.CharField(max_length=3, null=True, blank=True)
    ...
    svadicional2 = models.CharField(max_length=3, null=True, blank=True)
    ...
    ru_tension_sv = models.CharField(max_length=3, null=True, blank=True)
