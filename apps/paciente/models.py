...
class Radiologia(models.Model):
    ...
    svadicional2 = models.CharField(max_length=25, null=True, blank=True)
...
class Uci(models.Model):
    ...
    dexmedetomidina = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    dexmedetomidina_dt = models.CharField(max_length=50, null=True, blank=True)
    morfina = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    morfina_dt = models.CharField(max_length=50, null=True, blank=True)
    hidromorfona = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    hidromorfona_dt = models.CharField(max_length=50, null=True, blank=True)
    fentanyl = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    fentanyl_dt = models.CharField(max_length=50, null=True, blank=True)
    fenitoina = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    fenitoina_dt = models.CharField(max_length=50, null=True, blank=True)
    topiramato = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    topiramato_dt = models.CharField(max_length=50, null=True, blank=True)
    acido_valproico = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    acido_valproico_dt = models.CharField(max_length=50, null=True, blank=True)
    levetiracetam = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    levetiracetam_dt = models.CharField(max_length=50, null=True, blank=True)
    lacosamida = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    lacosamida_dt = models.CharField(max_length=50, null=True, blank=True)
    clozapina = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    clozapina_dt = models.CharField(max_length=50, null=True, blank=True)
    haloperidol = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    haloperidol_dt = models.CharField(max_length=50, null=True, blank=True)
    ketiapina = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    ketiapina_dt = models.CharField(max_length=50, null=True, blank=True)
    carbamacepina = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
    carbamacepina_dt = models.CharField(max_length=50, null=True, blank=True)
    carbonato_litio = models.CharField(choices=seleccion_CHOICES, max_length=12, null=True)
