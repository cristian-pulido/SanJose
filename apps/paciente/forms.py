...
class IngresoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'a_toxico_alergenicos': forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('Deje en blanco si no se cumple')}),
            ...
            'a_familiares': forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('Deje en blanco si no se cumple')}),
...
class RadiologiaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'ur_frecuencia_cardiaca_sv':forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('latidos/min')}),
            'ur_frecuencia_respiratoria_sv':forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('respiraciones/min')}),
            'ur_visoscopio_sv':forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('')}),
            'ur_tension_sv':forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('mmhg')}),
            ...
            'analgesia_sv':forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('latidos/min')}),
            'relajacion_dt': forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('')}),
            'relajacion_sv': forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('respiraciones/min')}),
            'svadicional1': forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('')}),
            'svadicional2': forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('mmhg')}),
            ...
            'ru_frecuencia_cardiaca_sv':forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('latidos/min')}),
            'ru_frecuencia_respiratoria_sv':forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('respiraciones/min')}),
            'ru_visoscopio_sv':forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('')}),
            'ru_tension_sv':forms.TextInput(attrs={'class': 'form-control', 'placeholder': ('mmhg')}),
